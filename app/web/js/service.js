...
async function loadEditForm(id) {
   try {
       ...
       document.getElementById('editServiceId').value = service.id; // ID do serviço
       document.getElementById('editServiceType').value = service.service_type; 
       document.getElementById('editServiceDate').value = service.service_date ? new Date(service.service_date).toISOString().split('T')[0] : ''; // Formato ISO
